    ...
    <div class="w-full h-fit bg-bg-primary dark:bg-bg-dark-primary p-4 rounded-lg">
        <form wire:submit='save'>
            ...
            <div class="mb-3 w-full flex space-x-3">
                <div class="w-1/3">
                    <div class="w-full">
                        <label for="ingredient" class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">
                            Ingredient
                            <span class="text-xs text-red-500">
                                *
                            </span>
                        ...
                        <div class="flex space-x-2 items-center">
                            <select wire:model.live='ingredient' type="text" id="ingredient"
                                ...
                                class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-bg-dark-primary dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark dark:shadow-xs-light font-normal"
                                placeholder="Nasi Goreng">
                                <option value="" selected>--Pilih Ingredient--</option>
                ...
                <div class="w-2/3">
                    <p class="text-sm mb-1">Ingredient Terpilih :</p>
                                ...
                                <div class="w-[75%] h-full flex flex-col justify-between">
                                    <div class="flex justify-between space-x-2">
                                        <div class="w-[90%] h-fit">
                                            <p class="text-base font-medium">{{ $ingredient['name'] }}</p>
                                        </div>
                                    ...
                                    <div class="flex space-x-3">
                                        ...
                                        <div class="space-y-1">
                                            ...
                                            <select
                                                ...
                                                class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg block w-full px-2 py-1.5 dark:bg-bg-dark-primary dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark dark:shadow-xs-light font-normal">
                                                <option value="pcs"
                                                    {{ $ingredient['unit'] == 'pcs' ? 'selected' : '' }}>pcs</option>
                                                <option value="butir"
                                                    {{ $ingredient['unit'] == 'butir' ? 'selected' : '' }}>butir
                                                </option>
                                                <option value="siung"
                                                    {{ $ingredient['unit'] == 'siung' ? 'selected' : '' }}>siung
                                                </option>
                                                <option value="gram"
                                                    {{ $ingredient['unit'] == 'gram' ? 'selected' : '' }}>gram</option>
                                                <option value="kg"
                                                    {{ $ingredient['unit'] == 'kg' ? 'selected' : '' }}>kg</option>
                                                <option value="ml"
                                                    {{ $ingredient['unit'] == 'ml' ? 'selected' : '' }}>ml</option>
                                                <option value="porsi"
                                                    {{ $ingredient['unit'] == 'porsi' ? 'selected' : '' }}>porsi
                                                </option>
                                            </select>
                                        </div>
                                    </div>
            ...
            <div class="flex items-center justify-end space-x-2 pt-3 px-4">
                <a href="{{ route('recipes.index') }}" wire:navigate
                    class="py-2 px-5 text-sm font-medium text-text-primary dark:text-text-dark-primary border border-gray-500 hover:bg-gray-500 hover:text-text-dark-primary rounded-md transition duration-300">Batal</a>
