            ...
            <div class="flex items-center justify-end space-x-2 pt-3 px-4">
                ...
                @if ($recipe?->moderation?->status == 'rejected' && (bool) $status)
                    <button type="submit" wire:loading.attr="disabled" wire:target='save'
                        class="flex justify-center items-center space-x-2 text-white bg-gradient-to-br from-secondary to-secondary-light hover:from-secondary-hover hover:to-secondary border border-secondary px-6 py-2 text-sm text-center rounded-md transition-colors duration-300">
                        Ajukan Ulang Resep
