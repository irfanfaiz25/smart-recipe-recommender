<div
    ...
    <div class="bg-white dark:bg-bg-dark-secondary p-8 rounded-2xl">
        <form wire:submit.prevent='save' class="space-y-6">
                ...
                <div class="col-span-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="tel" id="phone" wire:model="phoneNumber"
                            class="w-full pl-10 pr-4 py-3 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary dark:focus:ring-primary-light focus:border-primary dark:focus:border-primary-light bg-white dark:bg-bg-dark-primary text-gray-900 dark:text-white"
            ...
            <div class="pt-4">
                <button type="submit"
                    class="w-full py-4 px-6 bg-gradient-to-r from-primary via-primary-light to-primary bg-300% animate-shine text-white text-sm md:text-lg font-bold rounded-lg shadow-lg hover:shadow-xl transition-all transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-light">
