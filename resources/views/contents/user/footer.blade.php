<footer class="bg-gradient-to-br from-neutral-50 via-neutral-100 to-neutral-50 text-gray-900 relative overflow-hidden">
    ...
    <button id="scrollToTop"
        class="fixed bottom-20 right-2 md:bottom-8 md:right-8 w-10 h-10 md:w-12 md:h-12 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 opacity-0 invisible z-50"
