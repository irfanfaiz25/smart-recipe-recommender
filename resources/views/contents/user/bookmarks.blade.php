...
@section('content')
    <div class="mt-16 py-10 px-4 md:px-20 page-background min-h-screen bg-fixed bg-repeat relative">
        ...
        <div x-show="pageLoaded" x-transition:enter="transform transition-all duration-700 ease-out"
            ...
            <div>
                <h1 class="text-3xl md:text-[44px] font-display text-center text-secondary mb-3">Koleksi Resep Favorit</h1>
                <h1 class="text-base md:text-lg font-sans font-medium text-center">Temukan kembali resep-resep istimewa yang
                    telah kamu
                    simpan</h1>
            </div>
