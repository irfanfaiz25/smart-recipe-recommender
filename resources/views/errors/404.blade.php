...
<body>
    <div class="min-h-screen flex items-center justify-center bg-gray-50 relative overflow-hidden">
        ...
        <div class="max-w-md w-full text-center relative z-10">
            <div class="mb-8">
                <h1 class="text-8xl font-bold text-secondary animate-bounce-slow">404</h1>
                <h2 class="text-2xl font-semibold font-display text-primary mb-4">Halaman Tidak Ditemukan</h2>
